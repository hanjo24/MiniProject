  ...
  return (
    ...
    <div class = "card">
      ...
      <div class = "content">
        ...
        <div className='links'>
        <a href=''><img src={github} width="20px"></img></a>
        <a href=''><img src={link} width="20px"></img></a>
        </div>
      </div>
    </div>    
  </div>
  ...
  <div class = "container">
    <div class = "card">
      ...
      <div class = "content">
        ...
        <p>DIn publishing and graphic design,Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content.</p>
        <div className='links'>
        <a href=''><img src="\images\github-brands.svg" width="20px"></img></a>
        <a href=''><img src="\images\link-solid.svg" width="20px"></img></a>
        </div>
      </div>
    </div>    
  </div>
    ...
    <div className='pillars'>
        ...
        <div className='pillar-description pillar'>
            <h3>01</h3>
            <h2>People</h2>
